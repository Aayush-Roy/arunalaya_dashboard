...
// const role = auth?.role; // "admin" | "manager" | "frontdesk"
...
//   //   { path: "/agents", icon: CalendarDays, label: "All Agents" },
//   //    // ✅ New Bookings Button
//   //   //  {path:'/status',icon:CalendarDays, label:"Status"}
//   // ];
//   const navItems = [
//   { path: "/", icon: LayoutDashboard, label: "Dashboard", roles: ["admin", "manager", "frontdesk"] },

//   { path: "/create", icon: Plus, label: "Create Service", roles: ["admin"] },

//   { path: "/services", icon: List, label: "All Services", roles: ["admin"] },

//   { path: "/bookings", icon: CalendarDays, label: "All Bookings", roles: ["admin", "manager", "frontdesk"] },

//   { path: "/agents", icon: CalendarDays, label: "All Agents", roles: ["admin", "manager"] },
// ];
...
// {role === "frontdesk" && (
//   <>
//     <div className="mt-6 mb-2 px-2 text-xs uppercase tracking-wider text-gray-500">
//       Front Desk Tools
//     </div>
...
//         location.pathname === "/frontdesk-assign"
...
//     <Link
//       to="/frontdesk-reschedule"
//       className={`group flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-300 font-medium ${
//         location.pathname === "/frontdesk-reschedule"
...
function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-gradient-to-b from-[#1e1e1e] to-[#121212] border-r border-gray-800 min-h-screen flex flex-col shadow-lg shadow-black/30">
      {/* Logo */}
      ...
      {/* Footer */}
      <div className="p-5 border-t border-gray-800 text-gray-500 text-sm text-center">
        © 2025 <span className="text-[#f88310]">Aayush</span>
      </div>
    </aside>
  );
}
